...
public class WaitHelper {
	...
	public void WaitForElementVisibleWithPollingTime(WebElement element, int timeOutInSeconds,
		...
		log.info(element.toString()+" element is visible now");
	}
	...
	public void WaitForElementClickable(WebElement element, int timeOutInSeconds) {
		...
		log.info(element.toString()+" element is clickable now");
	}
	...
	public boolean waitForElementNotPresent(WebElement element, long timeOutInSeconds) {
		...
		log.info(element.toString()+" element is invisibile now");
		return status;
	}
	...
	public void pageLoadTime(long timeout, TimeUnit unit){
		...
		log.info(driver.getTitle()+" page is loaded");
	}
